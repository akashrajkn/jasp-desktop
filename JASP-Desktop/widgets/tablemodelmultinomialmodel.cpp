...
#include "tablemodelmultinomialmodel.h"
...
TableModelMultinomialModel::TableModelMultinomialModel(QObject *parent) :
	TableModel(parent)
{
	_boundTo = NULL;
}

void TableModelMultinomialModel::bindTo(Option *option)
{
	_boundTo = dynamic_cast<OptionsTable *>(option);

	qDebug() << "---------------------";
	qDebug() << "TableModelMultinomialModel::bindTo";
	qDebug() << "---------------------";
}
