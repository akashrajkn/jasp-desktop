...
JASPControl
{
	id:							randomEffectsGroupingFactors
	controlType:				"RandomEffectsGroupingFactors"
	width:						parent.width
	implicitWidth:				width
	...
	Text
	{
		...
		text:			randomEffectsGroupingFactors.title
		height:			randomEffectsGroupingFactors.title ? 20 * preferencesModel.uiScale : 0
		font:			Theme.font
	...
	Rectangle
	{
		...
		anchors.left:	parent.left
		height:			randomEffectsGroupingFactors.height - text.height
		width:			parent.width
		...
		GridView
		{
			...
			model:				randomEffectsGroupingFactors.model
