...
DECLARE_ENUM(qmlControlType, JASPControl, CheckBox, Switch, TextField, RadioButtonGroup, VariablesListView, ComboBox, RepeatedMeasuresFactorsList, RandomEffectsGroupingFactors, TableView, Slider, TextArea, Button, FactorsForm);
