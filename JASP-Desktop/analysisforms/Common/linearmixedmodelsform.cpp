...
#include "linearmixedmodelsform.h"
#include "ui_linearmixedmodelsform.h"

LinearMixedModelsForm::LinearMixedModelsForm(QWidget *parent) :
	AnalysisForm("LinearMixedModelsForm", parent),
	ui(new Ui::LinearMixedModelsForm)
{
	ui->setupUi(this);
