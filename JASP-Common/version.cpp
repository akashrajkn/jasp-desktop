...
{
    return ((this->major > version.major) || (this->major == version.major && this->minor > version.minor) || (this->major == version.major && this->minor == version.minor && this->revision > version.revision) || (this->major == version.major && this->minor == version.minor && this->revision == version.revision && this->build > version.build));
}
