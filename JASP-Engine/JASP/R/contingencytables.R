...
ContingencyTables <- function(
  ...
  if (is.null(dataset)) {
    ...
    dataset <- .vdf(
        dataset, columns.as.factor = factors, columns.as.numeric = counts.var)
  }
  ...
  for (i in 1:length(analyses)) {
    ...
    if (!is.null(tables[["nominal.table"]])) {
      ...
      meta[[length(meta) + 1]] <- list(
          name = paste("Nominal Table", i), type = "table")
    ...
    if (!is.null(tables[["ordinal.table"]])) {
      ...
      meta[[length(meta) + 1]] <- list(
          name = paste("Ordinal Table", i), type = "table")
    ...
    if (!is.null(tables[["kendalls.table"]])) {
      ...
      meta[[length(meta) + 1]] <- list(
          name = paste("Kendalls Table", i), type = "table")
...
.crosstab <- function(dataset, options, perform, analysis) {
  ...
  if (options$countsExpected ||
      options$percentagesRow ||
      options$percentagesColumn || options$percentagesTotal) {

    counts.fields[[length(counts.fields) + 1]] <- list(
        name = "type[counts]", title = "", type = "string")

    if (options$countsExpected) {
      counts.fields[[length(counts.fields) + 1]] <- list(
          name = "type[expected]", title = "", type = "string")
    }

    if (options$percentagesRow) {

      counts.fields[[length(counts.fields) + 1]] <- list(
          name = "type[row.proportions]", title = "", type = "string")
    }

    if (options$percentagesColumn) {

      counts.fields[[length(counts.fields) + 1]] <- list(
          name = "type[col.proportions]", title = "", type = "string")
    }

    if (options$percentagesTotal) {

      counts.fields[[length(counts.fields) + 1]] <- list(
          name = "type[proportions]", title = "", type = "string")
    }
  ...
  for (column.name in lvls) {
    ...
    if (options$countsExpected) {
      ...
      counts.fields[[length(counts.fields) + 1]] <- list(
          name = private.name, title = column.name, type = "number",
          format = "sf:4;dp:2")
    }
  ...
  if (options$percentagesRow) {
    ...
    counts.fields[[length(counts.fields) + 1]] <- list(
        name = "total[row.proportions]", title = "Total", type = "number",
        format = "dp:1;pc")
  }
  ...
  if (options$percentagesColumn) {
    ...
    counts.fields[[length(counts.fields) + 1]] <- list(
        name = "total[col.proportions]", title = "Total", type = "number",
        format = "dp:1;pc")
  }
  ...
  if (options$percentagesTotal) {
    ...
    counts.fields[[length(counts.fields) + 1]] <- list(
        name = "total[proportions]", title = "Total", type = "number",
        format = "dp:1;pc")
  }
  ...
  if (options$chiSquared ||
      options$chiSquaredContinuityCorrection || options$likelihoodRatio) {
    ...
    if (options$chiSquared) {
      ...
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "type[chiSquared]", title = "", type = "string")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "value[chiSquared]", title = "Value", type = "number",
          format = "sf:4;dp:3")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "df[chiSquared]", title = "df", type = "integer")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "p[chiSquared]", title = "p", type = "number",
          format = "dp:3;p:.001")
      if (options$VovkSellkeMPR) {
        tests.fields[[length(tests.fields) + 1]] <- list(
            name = "MPR[chiSquared]", title = "VS-MPR", type = "number",
            format = "sf:4;dp:3")
      }
    }
    ...
    if (options$chiSquaredContinuityCorrection) {
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "type[chiSquared-cc]", title = "", type = "string")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "value[chiSquared-cc]", title = "Value", type = "number",
          format = "sf:4;dp:3")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "df[chiSquared-cc]", title = "df", type = "integer")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "p[chiSquared-cc]", title = "p", type = "number",
          format = "dp:3;p:.001")
      if (options$VovkSellkeMPR) {
        tests.fields[[length(tests.fields) + 1]] <- list(
            name = "MPR[chiSquared-cc]", title = "VS-MPR", type = "number",
            format = "sf:4;dp:3")
      }
    }
    ...
    if (options$likelihoodRatio) {
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "type[likelihood]", title = "", type = "string")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "value[likelihood]", title = "Value", type = "number",
          format = "sf:4;dp:3")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "df[likelihood]", title = "df", type = "integer")
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "p[likelihood]", title = "p", type = "number",
          format = "dp:3;p:.001")
      if (options$VovkSellkeMPR) {
        tests.fields[[length(tests.fields) + 1]] <- list(
            name = "MPR[likelihood]", title = "VS-MPR", type = "number",
            format = "sf:4;dp:3")
      }
    }
    ...
    if (counts.fp) {
      ...
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "value[N]", title = "Value", type = "number",
          format = "sf:4;dp:2")
    ...
    tests.fields[[
        length(tests.fields) + 1]] <- list(name = "df[N]", title = "df")
    tests.fields[[length(tests.fields) + 1]] <- list(name = "p[N]", title = "p")
    if (options$VovkSellkeMPR) {
      tests.fields[[length(tests.fields) + 1]] <- list(
          name = "MPR[N]", title = "VS-MPR", type = "number",
          format = "sf:4;dp:3")
    }
  ...
  if (options$oddsRatio) {
    ...
    odds.ratio.fields[[length(odds.ratio.fields) + 1]] <- list(
        name = "type[oddsRatio]", title = "", type = "string")
    odds.ratio.fields[[length(odds.ratio.fields) + 1]] <- list(
    ...
    odds.ratio.fields[[length(odds.ratio.fields) + 1]] <- list(
        name = "type[FisherTest]", title = "", type = "string")
    odds.ratio.fields[[length(odds.ratio.fields) + 1]] <- list(
        name = "value[FisherTest]", title = "Log Odds Ratio", type = "number",
        format = "sf:4;dp:3")
    odds.ratio.fields[[length(odds.ratio.fields) + 1]] <- list(
        name = "low[FisherTest]", title = "Lower", overTitle = ci.label,
        type = "number", format = "dp:3")
    odds.ratio.fields[[length(odds.ratio.fields) + 1]] <- list(
        name = "up[FisherTest]", title = "Upper", overTitle = ci.label,
        type = "number", format = "dp:3")
  ...
  if (options$contingencyCoefficient ||
      options$phiAndCramersV || options$lambda) {
    ...
    if (options$contingencyCoefficient) {
      ...
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "type[ContCoef]", title = "", type = "string")
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "value[ContCoef]", title = "Value", type = "number",
          format = "sf:4;dp:3")
    }

    if (options$phiAndCramersV) {
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "type[PhiCoef]", title = "", type = "string")
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "value[PhiCoef]", title = "Value", type = "number",
          format = "sf:4;dp:3")
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "type[CramerV]", title = "", type = "string")
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "value[CramerV]", title = "Value", type = "number",
          format = "sf:4;dp:3")
    }

    if (options$lambda) {
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "type[LambdaR]", title = "", type = "string")
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "value[LambdaR]", title = "Value", type = "number",
          format = "sf:4;dp:3")
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "type[LambdaC]", title = "", type = "string")
      nominal.fields[[length(nominal.fields) + 1]] <- list(
          name = "value[LambdaC]", title = "Value", type = "number",
          format = "sf:4;dp:3")
    }
  ...
  if (options$gamma) {
    ...
    ordinal.fields[[length(ordinal.fields) + 1]] <- list(
        name = "value[gammaCoef]", title = "Gamma", type = "number",
        format = "sf:4;dp:3")
    ordinal.fields[[length(ordinal.fields) + 1]] <- list(
        name = "Sigma[gammaCoef]", title = "Standard Error", type = "number",
        format = "dp:3")
    ordinal.fields[[length(ordinal.fields) + 1]] <- list(
        name = "low[gammaCoef]", title = "Lower", overTitle = ci.label,
        type = "number", format = "dp:3")
    ordinal.fields[[length(ordinal.fields) + 1]] <- list(
        name = "up[gammaCoef]", title = "Upper", overTitle = ci.label,
        type = "number", format = "dp:3")
  ...
  if (options$kendallsTauB) {
    ...
    kendalls.fields[[length(kendalls.fields) + 1]] <- list(
        name = "value[kTauB]", title = "Kendall's Tau-b ", type = "number",
        format = "sf:4;dp:3")
    kendalls.fields[[length(kendalls.fields) + 1]] <- list(
        name = "statistic[kTauB]", title = "Z", type = "number",
        format = "dp:3")
    kendalls.fields[[length(kendalls.fields) + 1]] <- list(
        name = "p[kTauB]", title = "p", type = "number", format = "dp:3;p:.001")
    if (options$VovkSellkeMPR) {
      kendalls.fields[[length(kendalls.fields) + 1]] <- list(
          name = "MPR[kTauB]", title = "VS-MPR", type = "number",
          format = "sf:4;dp:3")
    }
  ...
  if (is.null(counts.var) == FALSE) {
    ...
    if (any(counts < 0) || any(is.infinite(counts))) {
      ...
      status$error <- TRUE
      status$errorMessage <-
          "Counts may not contain negative numbers or infinities"
    }
  }
  ...
  for (i in 1:length(group.matrices)) {
    ...
    next.rows <- .crosstabsCreateCountsRows(
        analysis$rows, group.matrix, options, perform, group, status)
    counts.rows <- c(counts.rows, next.rows)

    next.rows <- .crosstabsCreateTestsRows(
        analysis$rows, group.matrix, tests.footnotes, options, perform, group,
        status)
    tests.rows <- c(tests.rows, next.rows)

    next.rows <- .crosstabsCreateOddsRatioRows(
        analysis$rows, group.matrix, odds.ratio.footnotes, options, perform,
        group, status)
    odds.ratio.rows <- c(odds.ratio.rows, next.rows)

    next.rows <- .crosstabsCreateNominalRows(
        analysis$rows, group.matrix, nominal.footnotes, options, perform, group,
        status)
    nominal.rows <- c(nominal.rows, next.rows)

    next.rows <- .crosstabsCreateOrdinalRows(
        analysis$rows, group.matrix, ordinal.footnotes, options, perform, group,
        status)
    ordinal.rows <- c(ordinal.rows, next.rows)

    next.rows <- .crosstabsCreateOrdinalTau(
        analysis$rows, group.matrix, kendalls.footnotes, options, perform,
        group, status)
  ...
  if (options$chiSquared ||
    ...
    if (status$error) tests.table[["error"]] <- list(errorType = "badData")
  ...
  if (options$oddsRatio) {
    ...
    if (status$error) odds.ratio.table[["error"]] <- list(errorType = "badData")
  ...
  if (options$contingencyCoefficient ||
    ...
    if (status$error) nominal.table[["error"]] <- list(errorType = "badData")
  ...
  if (options$gamma) {
    ...
    if (status$error) ordinal.table[["error"]] <- list(errorType = "badData")
  ...
  if (options$kendallsTauB) {
    ...
    if (status$error) kendalls.table[["error"]] <- list(errorType = "badData")
...
.crosstabsCreateTestsRows <- function(
    var.name, counts.matrix, footnotes, options, perform, group, status) {
    ...
    if (perform == "run" && status$error == FALSE && status$ready) {
      ...
      if (class(chi.result) == "try-error") {
        ...
        if (error == "at least one entry of 'x' must be positive")
          error <-
              "\u03A7\u00B2 could not be calculated, contains no observations"
        ...
        message <-
            "\u03A7\u00B2 could not be calculated - At least one row or column contains all zeros"
...
.crosstabsCreateNominalRows <- function(
    var.name, counts.matrix, footnotes, options, perform, group, status) {
  ...
  if (options$contingencyCoefficient) {
    ...
    if (perform == "run" && status$error == FALSE) {
      ...
      if (class(chi.result) == "try-error") {
        ...
        sup <- .addFootnote(
            footnotes,
            "Value could not be calculated - At least one row or column contains all zeros")
        row.footnotes[["value[ContCoef]"]] <- list(sup)
  ...
  if (options$lambda) {
    ...
    row[["type[LambdaR]"]] <- paste(
        "Lambda (", options$rows, "dependent)", sep = " ")
    ...
    if (perform == "run" && status$error == FALSE) {
      ...
      if (is.na(lambda)) {
        ...
        sup <- .addFootnote(
            footnotes,
            "Value could not be calculated - At least one row sums or column sums contains all zeros")
  ...
  if (options$lambda) {
    ...
    row[["type[LambdaC]"]] <- paste(
        "Lambda (", options$columns, "dependent)", sep = " ")
...
.crosstabsCreateOrdinalRows <- function(
    var.name, counts.matrix, footnotes, options, perform, group, status) {
...
.crosstabsCreateOrdinalTau <- function(
    var.name, counts.matrix, footnotes, options, perform, group, status) {
      ...
      chi.result <- try(
          {
            ...
            chi.result <- stats::cor.test(
                as.numeric(Var1), as.numeric(Var2), method = "kendall")
...
.crosstabsCreateOddsRatioRows <- function(
    var.name, counts.matrix, footnotes, options, perform, group, status) {
...
.crosstabsCreateCountsRows <- function(
    var.name, counts.matrix, options, perform, group, status) {
  ...
  for (i in 1:dim(counts.matrix)[[1]]) {
    ...
    if (perform == "run" && status$error == FALSE && status$ready) {
      ...
      if (options$percentagesTotal) {
        ...
        names(
            proportions) <- paste(names(proportions), "[proportions]", sep = "")

        if (class(proportions.matrix[1, 1]) == "character") {
          proportions[["total[proportions]"]] <- ""
        } else {
          proportions[["total[proportions]"]] <- .clean(
              base::sum(proportions.matrix[i, ]))
        }
...
.crosstabsCreateGroupMatrices <- function(
    dataset, rows, columns, groups, counts = NULL, rowOrderDescending = FALSE,
    columnOrderDescending = FALSE, perform = "run", status = NULL) {
