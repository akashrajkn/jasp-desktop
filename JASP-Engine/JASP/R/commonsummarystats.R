...
.getBayesfactorTitle.summarystats.ttest <- function(
    bayesFactorType, hypothesis) {
  ...
  if (hypothesis == "groupsNotEqual" ||
      hypothesis == "notEqualToTestValue" || hypothesis == "correlated") {
