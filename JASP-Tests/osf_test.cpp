...
void OSFTest::loginAuthenticationTest_data()
{
    ...
    QTest::newRow("1") << "jasp.tester@gmail.com"
                       << "testerJASP" << true;
    QTest::newRow("2") << "Hello.com"
                       << "123456qwerty" << false;
    QTest::newRow("3") << "jasp.tester@gmail.com"
                       << "12345qwerty" << false;
    QTest::newRow("4") << "osftester1@yopmail.com"
                       << "!@#$%^" << true;
    QTest::newRow("5") << "osftester2@yopmail.com"
                       << "" << false;
    QTest::newRow("6") << ""
                       << "12345qwerty" << false;
    QTest::newRow("7") << ""
