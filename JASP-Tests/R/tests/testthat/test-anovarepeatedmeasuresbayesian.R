    ...
    "Main table results match",
    {
      ...
      refTables <- list(
          nullModelTop = list(
              ...
              -0.386112116395769,
              7.76323643953116,
              "RM Factor 1 + facGender",
              0.1,
              -0.333725484709657,
              0.891141584222282,
              23.5407686403752,
              9.48562764001249,
              "RM Factor 1 + facGender + RM Factor 1<unicode><unicode><unicode>facGender",
              0.1,
              -1.22109858280499,
              -0.239935999954474,
              22.6533955422798,
              ...
              -1.03533851265525,
              13.7488070754196,
              "RM Factor 1 + facGender + contcor1",
              0.1,
              -1.11529732351552,
              -0.126405348442144,
              22.7591968015693,
              15.7870140533182,
              "RM Factor 1 + facGender + RM Factor 1<unicode><unicode><unicode>facGender + contcor1",
              0.1,
              -2.03617619580061,
              -1.0779193502007,
              21.8383179292842,
      ...
      for (order in c("nullModelTop", "bestModelTop")) {
        ...
        results <- JASPTools::run("AnovaRepeatedMeasuresBayesian", "debug.csv",
...
test_that(
    "Effects table results match",
    {
      ...
      refTables <- list(
          allModels = list("RM Factor 1", 0.6, 1, "<unicode>", "facGender", 0.6,
                           0.757389476581774, 2.08122183080559,
                           "RM Factor 1<unicode><unicode><unicode>facGender",
                           0.2, 0.0790846685097528, 0.343504623304625),
          matchedModels = list(
              "RM Factor 1", 0.4, 0.920915331490247, 1.02806370019033e+24,
              "facGender", 0.4, 0.678304808072022, 2.79585896982186,
              "RM Factor 1<unicode><unicode><unicode>facGender", 0.2,
              0.0790846685097528, 0.1165916378133))
...
test_that(
    "Post-hoc Comparisons table results match",
    {
      ...
      options$repeatedMeasuresFactors <- list(
          list(levels = c("Level 1", "Level 2", "Level 3"),
               name = "RM Factor 1"))
      options$modelTerms <- list(
          list(components = "RM Factor 1", isNuisance = FALSE))
      ...
      expect_equal_tables(
          table,
          list("Level 1", "Level 2", 0.587401051968199, 83932041568197648,
               17.1549930670883, 2.78226779130567e-20, "TRUE", "Level 1",
               "Level 3", 0.587401051968199, 0.30644539432695,
               -0.282581621383003, 2.74342774324035e-05, "FALSE", "Level 2",
               "Level 3", 0.587401051968199, 48708968131887.4, 13.9186742094611,
               1.07201998003854e-19, "FALSE"))
    })
...
test_that(
    "Analysis handles errors",
    {
      ...
      expect_identical(
          ...
          "badData", label = "Inf RM factor check")
      ...
      options$modelTerms <- list(
          list(components = "RM Factor 1", isNuisance = TRUE))
      results <- JASPTools::run("AnovaRepeatedMeasuresBayesian", "debug.csv",
                                options, view = FALSE, quiet = TRUE)
      expect_identical(
          results[["results"]][["model comparison"]][["error"]][["errorType"]],
