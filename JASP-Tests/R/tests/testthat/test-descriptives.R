...
test_that(
    "Main table results match",
    {
      ...
      results <- JASPTools::run(
          "Descriptives", "debug.csv", options, view = FALSE, quiet = TRUE)
    ...
    "Frequencies table matches",
    {
      ...
      expect_equal_tables(
          ...
          list(0, "f", 26, 44.8275862068966, 44.8275862068966, 44.8275862068966,
               ...
               "FALSE", "", "Total", 58, 100, 100, "", 1, "f", 24,
               57.1428571428571, 57.1428571428571, 57.1428571428571, "TRUE", 1,
               "m", 18, 42.8571428571429, 42.8571428571429, 100, "FALSE", "",
               "Total", 42, 100, 100, ""))
    })
...
test_that("Distribution plot matches",
          {
            ...
            results <- JASPTools::run("Descriptives", "debug.csv", options,
