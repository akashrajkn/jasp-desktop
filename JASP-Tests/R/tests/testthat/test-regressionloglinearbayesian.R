    ...
    "General summary statistics table matches",
    {
      ...
      expect_equal_tables(
          ...
          list("(Intercept)",
               ...
               -0.122842441315205,
               0.155851155312602,
               "contBinom = 0*facFive = 1",
               0.571428571428571,
               0.00197519410432235,
               0.00569094808602158,
               -0.125500914290167,
               0.103584632765005,
               "contBinom = 0*facFive = 2",
               0.571428571428571,
               -0.0270367686155361,
               0.00624820819787772,
               -0.180746332353481,
               0.0610871410555307,
               "contBinom = 0*facFive = 3",
               0.571428571428571,
               0.00343309539396836,
               0.00598953855547496,
               -0.145370964229942,
               0.0973020746027855,
               "contBinom = 0*facFive = 4",
               0.571428571428571,
               -0.0218844778500034,
               0.00501003480774965,
               -0.131413707533984,
...
test_that(
    "Submodel summary statistics table matches",
    {
      set.seed(0)
      options <- initOpts()
      options$factors <- c("contBinom", "facFive")
      ...
      expect_equal_tables(
          table,
          list("(Intercept)", 2.29560729883006, 0.00945972825329099,
               2.12809954463567, 2.52220705393406, "contBinom = 0",
               0.045757962353209, 0.00487119274553831, -0.0378564465631073,
               0.235518792759572, "facFive = 1", -0.00411654631578624,
               0.00919225838347475, -0.189678327954162, 0.225524507296169,
               "facFive = 2", -0.00755884938209783, 0.0107688538955323,
               -0.230464286621307, 0.203303292163532, "facFive = 3",
               0.00693535371456428, 0.00958840576151784, -0.151633708350598,
               0.242411127225971, "facFive = 4", 0.00306711588492548,
